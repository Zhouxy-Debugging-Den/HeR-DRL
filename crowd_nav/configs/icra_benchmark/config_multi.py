...
class BaseEnvConfig(object):
    ...
    sim.circle_radius = 4
    sim.human_num = 5
    sim.other_robot_num=2
    sim.nonstop_human = False
    sim.nonstop_other_robot=False
    ...
    other_robot = Config()
    other_robot.visible = False
    other_robot.policy = 'orca'
    other_robot.radius = 0.3
    other_robot.v_pref = v_pref
    other_robot.sensor = 'coordinates'
    other_robot.rotation_constraint = rotation_constraint
    other_robot.multi=0
...
class BasePolicyConfig(object):
    ...
    st2 = Config()
    st2.multiagent_training = True
    st2.with_global_state=True
    st2.with_om=False
