...
from crowd_nav.policy.multi.ST.policy_factory import policy_factory
from crowd_sim.envs.utils.robot_multi_st import Robot
...
def main(args):
    ...
    explorer = Explorer(env, robot, device, None,st_frame_nums=3, gamma=0.9)
    ...
    if args.visualize:
        ...
        if args.traj:
            video_file = "new_pic/complex/" + str(
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model_dir', type=str, default='data/multi/st2_3frame')#None
